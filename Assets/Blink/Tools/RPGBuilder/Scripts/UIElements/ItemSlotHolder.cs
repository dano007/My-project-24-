...
namespace BLINK.RPGBuilder.UIElements
{
        ...
        IDropHandler
    {
        ...
        {
            RPGGameScene gameSceneREF = RPGBuilderUtilities.GetGameSceneFromName("GameSceneName");
            RPGBuilderEssentials.Instance.TeleportToGameScene(gameSceneREF.ID, RPGBuilderUtilities.GetWorldPositionFromID(gameSceneREF.startPositionID).position);
        }
