...
namespace BLINK.RPGBuilder.AI
{
    public class NPCSpawner : MonoBehaviour
    {
        ...
        private Vector3 GetSpawnPoint()
        {
            ...
            Vector3 spawnPos = new Vector3(Random.Range(position.x - areaRadius, position.x + areaRadius), position.y + areaHeight,
                Random.Range(position.z - areaRadius, position.z + areaRadius));
            return Physics.Raycast(spawnPos, -transform.up, out var hit, areaHeight, groundLayers) ? hit.point : position;
        }
